...
*send_newline*::
Send a newline (LF, 0x0A) character to the terminal. Useful for shells configured to treat LF differently from CR (e.g. for multi-line input). +
Default value: *<Shift>Return*
